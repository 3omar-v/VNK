...
function display(arr) {
  ...
  for (let i = 0; i < 3; i++) 
    ...
    cartoona += 
      `
      <div class="Featured_1 bg-white col-md-3 rounded-3 shadow-lg p-4">
        ...
        <div class="box_btn d-flex justify-content-between">
            <h6 style = "color:white;" class=" p-1 color_web rounded-1">${arr[i].region}</h6>
            <button class="view_details btn btn-outline-info">
                View Details
            </button>
        </div>
      </div>
